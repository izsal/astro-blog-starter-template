...
export const FALLBACK_PROJECTS: ProjectItem[] = [
	{
		...
		description:
			"Aplikasi streaming video interaktif dengan responsivitas tinggi, navigasi modern, filter genre film, dan UI autentik Netflix.",
		tech_stack: ["React.js", "Next.js", "Tailwind CSS", "Vercel"],
		github_url: "https://github.com/izsal",
		live_url: "https://clone-netflix-coral.vercel.app/",
		featured: true,
		category: "Frontend",
	...
	},
	{
		...
		title: "Next.js 13 E-Commerce Store",
		description:
			"Toko online modern berfitur lengkap mencakup dynamic product catalog, shopping cart, dynamic routing, dan checkout workflow.",
		tech_stack: ["Next.js", "React", "TypeScript", "Tailwind CSS"],
		github_url: "https://github.com/izsal",
		live_url: "https://next13-ecommerece-store.vercel.app/",
		featured: true,
		category: "Fullstack",
	...
	{
		id: 3,
		slug: "itokin-qc-mobile",
		title: "ITOKIN Quality Control (QC) Mobile App",
		description:
			"Aplikasi mobile inspeksi kualitas lapangan yang dibangun dari awal dengan React Native, terintegrasi API real-time ke sistem ERP pusat.",
		tech_stack: ["React Native", "JavaScript", "REST APIs", "Mobile"],
		github_url: "https://github.com/izsal",
		live_url: null,
		featured: true,
		category: "Mobile App",
	...
	{
		id: 4,
		slug: "lahtube-video-platform",
		title: "LahTube Islamic Video Sharing Platform",
		description:
			"Platform video sharing lintas platform dengan infinite scroll performa tinggi, admin market interface, dan orkestrasi Docker Compose.",
		tech_stack: ["Fullstack", "Docker", "Video Streaming", "REST API"],
		github_url: "https://github.com/izsal",
		live_url: null,
		featured: true,
		category: "Fullstack",
	...
	},
	{
		id: 5,
		slug: "gis-pwa-wisata",
		title: "Web Wisata Berbasis GIS & PWA",
		description:
			"Aplikasi destinasi wisata berbasis peta interaktif spasial (GIS) dengan Mapbox dan kemampuan offline Progressive Web App (PWA).",
		tech_stack: ["Laravel", "React.js", "Mapbox", "PWA"],
		github_url: "https://github.com/izsal",
		live_url: null,
		featured: true,
		category: "GIS & Web",
	...
	{
		id: 6,
		slug: "e-office-run-market",
		title: "E-Office & Run Market B2B Platform",
		description:
			"Sistem administrasi perkantoran digital dan marketplace B2B dengan backend modular Golang, database migration, dan optimasi query.",
		tech_stack: ["Golang", "PostgreSQL", "Docker", "REST API"],
		github_url: "https://gitlab.com/izsalafandi/e-office",
		live_url: null,
		featured: false,
